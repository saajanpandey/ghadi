...
{{--            <div class="col-md-8">--}}
{{--                <div class="card">--}}
{{--                    <div class="card-header"><div class="card-header"> {{ isset($url) ? ucwords($url) : ""}} {{ __('Login') }}</div>--}}

{{--                    <div class="card-body">--}}

{{--                        <form method="POST" action='{{ url("$url/signin") }}' aria-label="{{ __('Login') }}">--}}
...
<div class="container-log-reg">
    ...
    <form action="{{ url("$url/signin") }}" method="post" class="form">
        @csrf
