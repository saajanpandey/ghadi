...
{{--                </div>--}}
        ...
        <form method="POST" action="{{route('brand.store')}}">
            ...
            <label class="col-md-4 control-label" for="name"> <h1>Brand Name</h1></label>

            <div class="col-md-3">

                <input id="brand_name" name="name" placeholder="Enter brand name" class="form-control input-md" type="text" >
