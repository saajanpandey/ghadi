...
{{--            <td><img src="/storage/cover_image/{{$image->imagelocation}}" alt="" style="width: 50px" ></td>--}}
{{--            @endforeach--}}
...
<div class="site-wrapper">
    ...
    <main class="main-wrapper">
        ...
        <h1 align="center"><strong>Product Detail</strong></h1>
        ...
        <div class="show-data">
            ...
            <table class="table table-bordered table-dark" border="0">
                ...
                <tr><th>Full Image</th>
                    @foreach($ad->images as $image)
                        <td><img src="/storage/cover_image/{{$image->imagelocation}}" alt=""></td>
                    @endforeach
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <a href="/ads/{{$ad->id}}/edit">
                            <input class="btn btn-success" value="Edit">
                        </a>
